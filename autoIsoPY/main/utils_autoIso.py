...
from autoIsoUTILS.rich_utils import get_progress
from autoIsoPY.data.utils.dataloaders import FixedIndicesEvalDataloader
...
def statcull_mahalanobis(pipeline, threshold=0.3):
