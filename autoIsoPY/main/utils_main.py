...
from autoIsoUTILS.rich_utils import CONSOLE, get_progress
from autoIsoPY.pipelines.base_pipeline import Pipeline
from autoIsoPY.pipelines.base_pipeline import VanillaPipelineConfig
from autoIsoPY.data.datamanagers.full_images_datamanager import FullImageDatamanagerConfig
from autoIsoPY.models.splatfacto import SplatfactoModelConfig
from autoIsoPY.data.dataparsers.colmap_dataparser import ColmapDataParserConfig
from autoIsoPY.data.dataparsers.nerfstudio_dataparser import NerfstudioDataParserConfig
from autoIsoPY.data.datasets.base_dataset import InputDataset
...
def render_loop(config, pipeline):

        render_root = config.datamanager.data.absolute().parent.parent
        render_name = config.datamanager.data.name
        output_dir =  render_root / Path("renders") / render_name
